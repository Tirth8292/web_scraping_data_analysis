                        ...
                        while ($row_pro = mysqli_fetch_assoc($rel61)) {
                            ...
                            <div class="ch-img">
                                ...
                                <div class="ch-pr-price5">
                                    ...
                                    <div class="ch-pr-price1">
                                    <h3 style="width: 140px;">Delivered</h3>
                                    </div>
                                    </div>';
                        }
                    }
